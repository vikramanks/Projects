from Backend.src.parser_prescription import PrescriptionPraser
import pytest
...
Refill: 3 times
'''
    return PrescriptionPraser(document_text)
...
def test_get_medicines(doc_1_maria, doc_2_virat, doc_3_empty):
    assert doc_1_maria.get_field('patient_medican') == 'Prednisone 20 mg\nLialda 2.4 gram'
    assert doc_2_virat.get_field('patient_medican') == 'Omeprazole 40 mg'
    assert doc_3_empty.get_field('patient_medican') is None
...
def test_parse(doc_1_maria, doc_2_virat, doc_3_empty):
    ...
    assert record_maria['patient_medican'] == 'Prednisone 20 mg\nLialda 2.4 gram'
    ...
    assert record_virat == {
        ...
        'patient_medican': 'Omeprazole 40 mg',
        'directions': 'Use two tablets daily for three months',
        'refill': '3'
    }
