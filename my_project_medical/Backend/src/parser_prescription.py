...
class PrescriptionPraser(MedicalDocParser):
    ...
    def parse(self):
        return {
            ...
            'patient_medican': self.get_field('patient_medican'),
    ...
    def get_field(self, field_name):
        pattern_dict = {
            ...
            'patient_medican': {'pattern': 'Address:[^\n]*(.*)Directions', 'flags': re.DOTALL},
...
if __name__ == "__main__":
    document_text = """
Name: Vikraman K S Date: 5/11/2022
...
Refill: 2 times
"""
    pp = PrescriptionPraser(document_text)
    print(pp.parse())
